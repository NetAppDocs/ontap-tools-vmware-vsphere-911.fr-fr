...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-availability.html["Documentation VMware vSphere : création et utilisation de clusters vSphere HA"^]
...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-availability/providing-fault-tolerance-for-virtual-machines/fault-tolerance-requirements-limits-and-licensing.html["Documentation VMware vSphere : exigences en matière de tolérance aux pannes, limites et licences"^]
