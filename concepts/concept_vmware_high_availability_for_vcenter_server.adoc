...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/7-0/vsphere-availability/creating-and-using-vsphere-ha-clusters.html["Documentation VMware vSphere : création et utilisation de clusters vSphere HA"^]
