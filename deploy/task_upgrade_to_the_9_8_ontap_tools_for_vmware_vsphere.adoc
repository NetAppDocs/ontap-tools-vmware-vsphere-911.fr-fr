...
[role="lead"]
Vous pouvez effectuer une mise à niveau sur place vers la dernière version des outils ONTAP à partir de votre version 9.10 ou ultérieure existante en suivant les instructions fournies ici.
