...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-resource-management.html["Documentation VMware vSphere : activation du contrôle des E/S du stockage"^]
